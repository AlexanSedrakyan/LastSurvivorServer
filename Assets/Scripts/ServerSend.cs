...
public class ServerSend
{
    ...
    public static void TileHealth(Tile _tile, int _health)
    {
        using (Packet _packet = new Packet((int)ServerPackets.tileHealth))
        {
    ...
    {
        using (Packet _packet = new Packet((int)ServerPackets.resetWorld))
        {
            SendTCPDataToAll(_packet);
        }
    }
